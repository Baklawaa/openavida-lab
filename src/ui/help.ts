...
export const CONTROL_HELP: Record<string, string> = {
  ...
  "gene-add-mutator": "Ajoute une cassette de mutabilité : elle multiplie le taux de mutation des naissances de cet organisme.",
  ...
  "dna-landscape": "Substitutions d’un codon dans les régions codantes, classées par fitness dans l’environnement de l’organisme sélectionné (ou du centre de la plaque). Cliquez pour appliquer dans la séquence.",
  "dna-landscape-best": "Les 10 substitutions qui augmentent le plus la fitness. Cliquez pour remplacer le codon (l’historique de l’éditeur enregistre le geste).",
  "dna-landscape-worst": "Les 10 substitutions qui diminuent le plus la fitness.",
  ...
  "tournament-picks": "Contestataires du tournoi : souches du monde actif et organismes enregistrés. 2 à 4 ; chaque paire (hors auto-appariement) est injectée à effectifs égaux.",
  "tournament-reps": "Nombre de réplicats indépendants par paire, à graines successives.",
  "tournament-max": "Budget de pas de chaque rencontre. La part de chaque souche est mesurée à la fin.",
  "btn-tournament-run": "Lance toutes les paires depuis l’état de départ de l’expérience. Vainqueur : plus grande part ; écart ≤ 10 % = nul.",
  "btn-tournament-csv": "Télécharge la matrice : paires, victoires, nuls, parts moyennes.",
  "tournament-matrix": "Matrice des confrontations. Une case (ligne, colonne) indique les victoires de la ligne contre la colonne ; l’intensité suit l’écart.",
  ...
  "model-legacy": "Restaure les réglages d’avant la mise à niveau (prédation par voisinage, mutualisme d’origine, pas de régulation). Approche le moteur v1 sans garantir un hash identique.",
  "btn-manifest": "Exporte le manifeste de la dernière course ciblée (état de départ, objectifs, graine, réplicats, paramètres) : le fichier se rejoue à l’identique avec le lanceur sans interface.",
  ...
  "sched-at": "Pas auquel l’action est appliquée (après les perturbations, avant le métabolisme).",
  "sched-action": "Type de changement : facteur d’échelle d’un champ, paramètre, ou touche de pinceau au centre de la plaque.",
  "sched-arg": "Facteur k, nouvelle valeur du paramètre, ou intensité de la touche.",
  "btn-sched-add": "Ajoute la ligne au programme du monde actif. Les réplicats d’une expérience héritant de cet état reçoivent le même programme.",
  "sched-list": "Lignes du programme. × retire une entrée. Les traits verticaux sur le graphique de fitness marquent ces pas.",
  ...
  "ex-compare": "Compare le génome de cette fiche à un autre organisme (n°), un organisme enregistré, ou l’organisme sélectionné sur la plaque. Alignement de Needleman–Wunsch (bande 48).",
  "ex-compare-id": "Numéro d’un organisme du catalogue à aligner sur cette fiche.",
  "ex-compare-saved": "Organisme enregistré localement à aligner sur cette fiche.",
  "ex-align": "Les deux séquences alignées, colonne par colonne. Les différences sont colorées. « Charger la comparaison » ouvre la seconde dans l’éditeur, comparée à la première.",
