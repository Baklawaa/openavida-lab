...
export const CONTROL_HELP: Record<string, string> = {
  ...
  "goal-reps": "Nombre de simulations indépendantes (jusqu’à 5000) lancées avec des graines successives, en parallèle sur tous les cœurs sauf un. Un réplicat s’arrête dès que l’objectif est atteint, que le monde est vide ou que l’objectif devient impossible.",
